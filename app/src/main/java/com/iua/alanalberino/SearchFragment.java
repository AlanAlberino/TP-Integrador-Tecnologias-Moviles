...
public class SearchFragment extends Fragment {
    ...
    public void onViewCreated(View view, @Nullable Bundle savedInstanceState) {
        ...
        movies = movieGenerator.initMovies1((MainActivity) getActivity());

        movieSearchAdapter = new MovieSearchAdapter(movies, getActivity().getApplicationContext());
        ...
        yourEditText = (EditText) getActivity().findViewById(R.id.editTextSearch);

        yourEditText.addTextChangedListener(new TextWatcher() {
        List<Movie> listaFiltrada = new ArrayList<Movie>();
            public void afterTextChanged(Editable s) {
                listaFiltrada = new ArrayList<Movie>();
